  ...
  <div class="card">
    <div class="card-body login-card-body">
      ...
      <form action="" method="post">
        <div class="text-center">
          <div class="row">
              ...
              <div class="col">
                  <select id="brand" style="width: 200px" class="form-select form-select-lg mb-3" aria-label=".form-select-lg example">
          ...
          <div class="row">
              ...
              <div class="col">
                  <select id="model" name="model" style="width: 200px" class="form-select form-select-lg mb-3" aria-label=".form-select-lg example">
          ...
          <div class="row">
              ...
              <div class="col">
                  <select id="year" name="year" style="width: 200px" class="form-select form-select-lg mb-3" aria-label=".form-select-lg example">
      ...
      <!-- <div class="social-auth-links text-center mb-1">
        ...
        <a onclick="reset()" id="reset" class="btn btn-block btn-danger">
